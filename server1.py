...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logging.info(f"Received /start from chat {chat_id}")
...
# Route to set webhook dynamically and check bot status
@app.route("/")
async def index():
    webhook_url = f"{(await request.url_root).rstrip('/')}/{BOT_TOKEN}"
